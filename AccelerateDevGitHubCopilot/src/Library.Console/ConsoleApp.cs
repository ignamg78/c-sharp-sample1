...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        // Buscar el libro en el archivo Books.json
        ...
        // Verificar si el libro está en préstamo en el archivo Loans.json
        var loan = _jsonData.Loans?.FirstOrDefault(l => l.BookItem!.BookId == book.Id && l.ReturnDate == null);
